...
more(N, Module, Sleep) when N > 1 ->
    ...
    %% seq(From, To) -> Seq. Returns a sequence of integers that starts with From and contains the successive results of adding Incr to the previous element, until To is reached or passed
    Ns = lists:seq(2,N),
